...
class WP_REST_PSR7_Response extends \WP_REST_Response implements ResponseInterface
{
    ...
    /**
     * @var string Text phrase describing the status code
     */
    protected $reasonPhrase;

    /**
     * Returns an instance of the class from a PSR7 Response
     *
     * @param ResponseInterface $response
     *
     * @return WP_REST_PSR7_Response
     */
    ...
    public function getBody()
    {
        if ( ! isset($this->bodyStream)) {
            ...
            $this->bodyStream = new BodyStream($stream);
        }
    ...
    public function withStatus($code, $reasonPhrase = '')
    {
        ...
        if (empty($reasonPhrase) && isset(self::$phrases[$clone->status])) {
            $reasonPhrase = self::$phrases[$clone->status];
        }
